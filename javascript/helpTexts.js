(function() {
    ...
    const helpTexts = {
        ...
        netAdditionalCost: "True additional cost needed for procurement after considering both On-Hand inventory AND existing Open Orders. This shows the actual additional purchase orders required, providing a more realistic procurement cost than the 'Additional Cost' metric.",
        ...
        netAdditionalQtyNeeded: "Additional quantity needed after considering both On-Hand inventory AND existing Open Orders. This shows the true additional procurement required, providing a more realistic view than Net Qty Needed.",
